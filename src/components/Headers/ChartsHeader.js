...
export const ChartsHeader = () => (
    <div className="jumbotron jumbotron-fluid mb-0 pb-0 pt-2 text-white" style={{ backgroundImage: 'linear-gradient(127deg, rgba(67,170,139,1) 0%, rgba(67,170,139,1) 0%)', bottom: 0, width: '100%' }}>
        <div className="container">
            <h1 className="display-4">COVID-19 Data Visualizer</h1>
            <hr />
            <p className="lead">A simple way to visualize the impact of COVID-19.</p>
        </div>
